...
export default function About() {
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      <Head>
        <title>عن شركة شذا الشام</title>
      </Head>
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center text-green-700 mb-10">عن شركة شذا الشام</h1>

        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">من نحن</h2>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">رؤيتنا</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">رسالتنا</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">قيمنا</h2>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">تاريخنا</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">خدماتنا</h2>
          <p className="text-gray-700 leading-relaxed">
