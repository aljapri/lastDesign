  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center text-green-700 mb-10">فرص العمل في شذا الشام</h1>
        <p className="text-center text-gray-600 mb-12">انضم إلى فريقنا وساهم في تقديم منتجات غذائية عالية الجودة.</p>

        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {jobs.map((job, index) => (
            <div key={index} className="bg-white shadow-lg rounded-lg p-6">
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">{job.title}</h2>
              <p className="text-green-600 mb-2">{job.location}</p>
              <p className="text-gray-700 mb-4">{job.description}</p>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">المتطلبات:</h3>
